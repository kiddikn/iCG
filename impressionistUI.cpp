...
Fl_Menu_Item ImpressionistUI::brushTypeMenu[NUM_BRUSH_TYPE+1] = {
  ...
  {"ScatteredCircles",FL_ALT+'s'+'c', (Fl_Callback *)ImpressionistUI::cb_brushChoice, (void *)BRUSH_SCATTEREDCIRCLES},
  {"Originals",FL_ALT+'o', (Fl_Callback *)ImpressionistUI::cb_brushChoice, (void *)BRUSH_ORIGINALS},
  //ブラシ追加
  {0}
};
...
ImpressionistUI::ImpressionistUI() {
	...
	m_brushDialog = new Fl_Window(400, 325, "Brush Dialog");
		...
		m_BrushWidthSlider->maximum(50); // スライダー最大値
